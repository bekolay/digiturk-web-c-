...
namespace digiturkpartnerweb.Areas.admin.Controllers
{
    ...
    public class paketkampanyasController : Controller
    {
        ...
        {
            var paket = db.paketkampanyas.Include(b => b.kategorikampanya);
            ViewBag.Aktifblog = db.paketkampanyas.Include(b => b.kategorikampanya).Where(p => p.paktif == false).ToList();
        ...
        public ActionResult Details(int? id)
        {
            ...
            paketkampanya paket = db.paketkampanyas.Find(id);
            if (paket == null)
            {
                ViewBag.kateid = new SelectList(db.kategorikampanyas, "kateid", "kateadi", paket.kateid);
                return HttpNotFound();
            }
            ViewBag.kateid = new SelectList(db.kategorikampanyas, "kateid", "kateadi", paket.kateid);
            return View(paket);
        ...
        {
            ViewBag.kateid = new SelectList(db.kategorikampanyas, "kateid", "kateadi");
            return View();
        }
        ...
        [ValidateInput(false)]
        public ActionResult Create([Bind(Include = "pid,kateid,padi,psenecekay1,psenecekay2,psenecekay3,psenecekay4,purl,pipadres,psenecekaciklama1,psenecekaciklama2,psenecekaciklama3,psenecekaciklama4," +
            ...
            "pinfiyat,pinfiyat2,pinfiyat3,pinfiyat4,pkampdetay,pinternet,paktif,pyazi,paysayi,panasayfaekle")] paketkampanya paket)
        {

            var paketlers = db.paketkampanyas.Where(a => a.padi == paket.padi).FirstOrDefault();
        ...
        [ValidateAntiForgeryToken]
        [ValidateInput(false)]
        public ActionResult Edit([Bind(Include = "pid,kateid,padi,psenecekay1,psenecekay2,psenecekay3,psenecekay4,purl,pipadres,psenecekaciklama1,psenecekaciklama2,psenecekaciklama3,psenecekaciklama4," +
            "psenecekfiyat1,psenecekfiyat2,psenecekfiyat3,psenecekfiyat4," +
            "paciklama,pfiyat,ptaraftar,ptarih,pdizi,pfilm,pspor,pmenuekle,pinadi,pinadi2,pinadi3,pinadi4,pinhiz,pinhiz2,pinhiz3,pinhiz4," +
            "pinfiyat,pinfiyat2,pinfiyat3,pinfiyat4,pkampdetay,pinternet,paktif,pyazi,paysayi,panasayfaekle")] paketkampanya paket)
        {
        ...
        {
            paketkampanya paket = db.paketkampanyas.Find(id);
            db.paketkampanyas.Remove(paket);
            db.SaveChanges();
